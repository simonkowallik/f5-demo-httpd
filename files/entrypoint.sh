...
F5DEMO_LISTEN_ADDR_SSL=${F5DEMO_LISTEN_ADDR_SSL-0.0.0.0}
F5DEMO_LISTEN_PORT=${F5DEMO_LISTEN_PORT-80}
F5DEMO_LISTEN_PORT_SSL=${F5DEMO_LISTEN_PORT_SSL-443}

# Wrap IPv6 addresses in [] for nginx
[[ "$F5DEMO_LISTEN_ADDR" == *:* ]] && F5DEMO_LISTEN_ADDR="[$F5DEMO_LISTEN_ADDR]"
[[ "$F5DEMO_LISTEN_ADDR_SSL" == *:* ]] && F5DEMO_LISTEN_ADDR_SSL="[$F5DEMO_LISTEN_ADDR_SSL]"
...
export F5DEMO_LISTEN_PORT
export F5DEMO_LISTEN_PORT_SSL

envsubst '$F5DEMO_NODENAME $F5DEMO_COLOR $F5DEMO_COLOR_SSL $F5DEMO_LISTEN_ADDR $F5DEMO_LISTEN_ADDR_SSL $F5DEMO_LISTEN_PORT $F5DEMO_LISTEN_PORT_SSL' < /etc/nginx/conf.d/f5demo.nginx.conf.template > /etc/nginx/conf.d/f5demo.nginx.conf
...
echo "F5DEMO_LISTEN_PORT: $F5DEMO_LISTEN_PORT"
echo "F5DEMO_LISTEN_PORT_SSL: $F5DEMO_LISTEN_PORT_SSL"
